...
#define ROLEPLAY_ADS			(1<<22) //OV ADD - Roleplay Add Maint

#define TOGGLES_DEFAULT (SOUND_ADMINHELP|SOUND_MIDI|SOUND_AMBIENCE|SOUND_LOBBY|SOUND_INSTRUMENTS|SOUND_PRAYERS|TOGGLE_FULLSCREEN|ROLEPLAY_ADS) //OV Edit: Roleplay Ads On by Default
...
GLOBAL_LIST_INIT(titles_list, list(TITLES_M, TITLES_F,TITLES_N)) // INSTRUCTIONS FOR DOWNSTREAM: Edit this or sanitize_character will eat them //OV Edit: Gender Neutral Revamp
