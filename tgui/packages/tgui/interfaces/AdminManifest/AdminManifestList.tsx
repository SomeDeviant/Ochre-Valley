          ...
          .map((player, i) => {
            return (
              <Table.Row key={i} className="candystripe">
                ...
                <Table.Cell verticalAlign="middle">{player.name}</Table.Cell>
                <Table.Cell verticalAlign="middle">{player.job}</Table.Cell>
                <Table.Cell verticalAlign="middle">
                  {player.category}
                </Table.Cell>
                <Table.Cell verticalAlign="middle">{player.afk}</Table.Cell>
                <Table.Cell verticalAlign="middle">
                  {STATE_DICT[player.state]}
                </Table.Cell>
                <Table.Cell verticalAlign="middle">{player.antag}</Table.Cell>
                <Table.Cell
